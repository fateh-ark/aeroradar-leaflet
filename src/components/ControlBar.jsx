    ...
    return (
        <div className='md:h-12 h-20 bg-slate-900 flex items-center justify-between z-0'>
            <div className='flex items-stretch text-white font-regular h-full md:w-auto md:justify-start md:mt-0 mt-1 w-full justify-between md:px-0 px-12'>
                <button className='py-auto px-4 flex md:flex-row md:my-0 my-auto flex-col items-center md:hover:bg-slate-700 md:active:bg-slate-800 md:focus:text-white hover:text-sky-200 focus:text-sky-400'><FontAwesomeIcon icon={faCog} className="md:text-base text-2xl"/>&nbsp;&nbsp;Settings</button>
                <button className='py-auto px-4 flex md:flex-row md:my-0 my-auto flex-col items-center md:hover:bg-slate-700 md:active:bg-slate-800 md:focus:text-white hover:text-sky-200 focus:text-sky-400'><FontAwesomeIcon icon={faFilter} className="md:text-base text-2xl"/>&nbsp;&nbsp;Filters</button>
                <button className='py-auto px-4 flex md:flex-row md:my-0 my-auto flex-col items-center md:hover:bg-slate-700 md:active:bg-slate-800 md:focus:text-white hover:text-sky-200 focus:text-sky-400'><FontAwesomeIcon icon={faHistory} className="md:text-base text-2xl"/>&nbsp;&nbsp;Playback</button>
            </div>
